...
def sudden_changes_mask_times(labels, datapath, null_val = 0.0, threshold_start = 75, threshold_change = 20, horizon=24):
    '''
...
def sudden_changes_mask(labels, datapath, null_val = 0.0, threshold_start = 75, threshold_change = 20, horizon=24):
    '''
    Create the mask for sudden change case.
    The parameter 'threshold_start' and 'threshold_change' can be changed.
    '''
