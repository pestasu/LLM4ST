...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Spatial-temporal Prediction Based on Pretrained LLM')

    # basic config
    parser.add_argument('--data', type=str, required=True, default='PEMS04', help='dataset name')
    parser.add_argument('--model', type=str, required=True, default='llm4st',
                        help='model name, options: [gwnet, fedformer, mtgnn...]')
    ...
    parser.add_argument('--save_iter', type=int, default=100, help='save model each save_iter')
